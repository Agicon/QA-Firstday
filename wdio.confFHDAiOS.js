...
const appPath = path.resolve(__dirname, "./pageobjects/testData/apps/FirstdayHC_Alert_Dev.app");
...
exports.config = {
    ...
    suites: {
        iOSLoginPageFHDA: ["./features/iOS/FHDA/login_Redirections_Logout_App.feature"],

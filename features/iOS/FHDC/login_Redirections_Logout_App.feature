Feature: Test suit for FHDC login,redirections and logout page

  Scenario Outline: User install or open the latest build and login to Firstday-HC caregiver app

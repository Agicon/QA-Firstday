Feature: Test cases for the 'Patient' page
  ...
  Scenario Outline: Create a static patient and verify this patient in mobile caregiver app
    ...
    Examples:
      ...
      | Patient_Auto_Test | Ben           | Male   | Default  | Caregiver_auto_test te (caregiverautotest@yopmail.com) (+1 232342347) | RPM,TELEMED,EMR | Hospital / Clinic | Active | Manage Patients                | Add A New Patient          | Discharge |
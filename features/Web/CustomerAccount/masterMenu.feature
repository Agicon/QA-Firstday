Feature: Test cases for "Master Menu" page
  ...
  Scenario Outline: Verify the create "New hospital/Office" functionality using both valid and invalid data also verify search and delete functionality
    When I click on the second index link Master
    When I click on the second index link Hospital/Office
    Then hospital page displays
    Then Search and delete duplicate data <name>
    When User click on the button text New Hospital
    When I click on the button with text Create
    Then validation message Please enter hospital/clinic name appears
    Then validation message Hospital shortname field is required. appears
